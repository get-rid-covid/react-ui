...
import classes from './PlasmaFilter.module.css'
        ...
        submitFilter = (event)=>{
            ...
            const data = this.mappingData(this.state.filterForm);
                if(this.props.isDonar){
                    this.props.onSubmitPlasmaFilter(data);
                }
                else{
                    this.props.onSubmitPlasmaReq(data);
                }
...
const mapDispatchToProps = (dispatch) =>{
    return {
        onSubmitPlasmaFilter : (details) => dispatch(orgAction.fetchDonarData(details)),
        onSubmitPlasmaReq : (details) =>dispatch(orgAction.fetchPlasmaReq(details)),
        onCloseFilter : () => dispatch(orgAction.onCloseFilter()),
    }
}

export default connect(mapStatesToProps,mapDispatchToProps)(PlasmaFilter);
