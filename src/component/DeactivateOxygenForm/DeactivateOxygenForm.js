...
import classes from './DeactivateOxygenForm.module.css'
...
class DeactivateOxygenForm extends Component{
...
export default connect(mapStatesToProps,mapDispatchToProps)(DeactivateOxygenForm);