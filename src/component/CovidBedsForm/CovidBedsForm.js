...
import classes from './CovidBedsForm.module.css'
...
class CovidBedsForm extends Component{
...
state = {
    ...
    covidBedForm:{
        ...
        ventilatorBeds_avail:{
            elementType: 'checkbox',
            value: false,
            labelValue:labi.Ventialtor_BEDS,
            id: 'ventilatorBeds_avail',
...
submitIntialDetailsHandler = (event) =>{
    ...
    console.log(details)
    this.props.initCovidBedSave(details);
}
mappingData = (data) =>{
    const details = {};
    for(let key in data){
...
const mapStatesToProps  = (state) =>{
    return{
        ...
        infoModel:state.commonReducer.infoModel,
        infoMessage:state.commonReducer.infoMessage
    }
}
const mapDispatchToProps = (dispatch) =>{
    return {
        initCovidBedSave : (details) => dispatch(orgAction.initCovidBedSave(details)),
        getAllDonarDetails : () => dispatch( orgAction.fetchDonarData({})),
        closeInfoModal : () => dispatch( orgAction.onCloseInfoModal())
    }
}

export default connect(mapStatesToProps,mapDispatchToProps)(CovidBedsForm);