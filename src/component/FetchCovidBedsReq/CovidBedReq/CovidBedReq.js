...
const details = (<div className={classes.InnerData}>
                  <div><strong>{labi.PAT_NAME}:</strong> {props.details.orgName}</div> 
                  <div><strong>{labi.CONT_NAME}: </strong>{props.details.contactName} </div> 
                  <div><strong>{labi.ADDRESS}:</strong> {props.details.address}</div>
                  <div><strong>{labi.Covid_BED_TYPE}:</strong> <strong style={{color:'red'}}> {props.details.covidBedType}</strong></div>                  
                   <div className='row'> 
