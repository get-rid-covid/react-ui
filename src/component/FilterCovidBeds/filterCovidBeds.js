...
import classes from './filterCovidBeds.module.css'
...
class CovidBedsFilter extends Component{
    state={
        filterForm:{
        ...
        submitFilter = (event)=>{
            ...
            const data = this.mappingData(this.state.filterForm);
                if(this.props.isDonar){
                    this.props.onSubmitCovidBeds(data);
                }
                else{
                    this.props.onSubmitCovidBedsReq(data);
                }
...
const mapDispatchToProps = (dispatch) =>{
    return {
        onSubmitCovidBeds : (details) => dispatch(orgAction.fetchCovidBeds(details)),
        onSubmitCovidBedsReq : (details) =>dispatch(orgAction.fetchCovidBedsReq(details)),
        onCloseFilter : () => dispatch(orgAction.onCloseModal()),
    }
}

export default connect(mapStatesToProps,mapDispatchToProps)(CovidBedsFilter);
